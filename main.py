...
def filter_save(param):
    ...
    # 파라미터 정의
    filter_filename = param[0]
    filter_str = param[1]

    result, msg, data = filter_conversations_test.save_filtered_data(filter_filename, filter_str)
    return result, msg, data
...
def filter_delete(param):
    ...
    result, msg, data = filter_conversations_test.delete_filtered_data(filter_filename, filter_id)
    return result, msg, data
...
def filter_read(param):
    ...
    result, msg, data = filter_conversations_test.retrieve_filtered_data(filter_filename, filter_id)
    return result, msg, data
...
def filter_apply(param):
    ...
    result, msg, data = filter_conversations_test.retrieve_filtered_data(filter_filename, filter_str)
    return result, msg, data
...
def filter_modify(param):
    ...
    result, msg, data = filter_conversations_test.modify_filtered_data(filter_filename, filter_id, filter_str)
    return result, msg, data
